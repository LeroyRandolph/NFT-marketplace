export default function Blog(props){
    ...
    return (
        <div>
            ...
            <p>Current Sample:</p>
            <h1>All Data in MarketPlace with DESC Ordering</h1><br></br>
            <p>Results: <br></br></p>
            {
                posts.Results.map(
                    (item) => 
...
export async function getStaticProps(context) {
    const res = await fetch("https://comp3334.test/DBTest/API/function.php", {
        ...
        body: JSON.stringify(
            {Process:"GetData", Table: "TABLE_MARKET", Columns: null, Conditions: null, Values: null,
                Orderby: "NFT_ID", Ordersort: "DESC", Extra: null}),	
    })
